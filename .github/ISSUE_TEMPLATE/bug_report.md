...
about: "Report a bug or suggest an improvement for caldip"
...
- caldip version: [if applicable]
- Virtualenv / Conda / System Python?: [env type]


## Checklist

- [ ] I have checked the existing [issues](https://github.com/eleanorfrajka/caldip/issues) to avoid duplicates.
