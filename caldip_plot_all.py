...
from caldip.plotting import create_universal_caldip_plot
...
Examples:
  ...
  python caldip_plot_all.py config.yaml --threshold 25.0 --min-duration 90
    ...
    parser.add_argument("--output", "-o", 
                       help="Output file for plot (HTML format)")
    parser.add_argument("--title", "-t", 
                       help="Plot title (default: from config or auto-generated)")
    parser.add_argument("--no-bottle-stops", action="store_true",
                       help="Disable bottle stop markers")
