...
default_mappings = {
    ...
    POTENTIAL_TEMPERATURE: ["potemp090C", "potemp190C"],
    SALINITY: ["sal00", "sal11", "PSAL2", "PSAL", "SAL", "Salinity"],
    CONDUCTIVITY: [
        "c0mS/cm",
        "cond0mS/cm",
        "c0",
    ...
    TURBIDITY: ["turbWETntu0", "Turbidity", "Backscatter"],
    DEPTH: ["depSM", "Depth"],
    TIME_J: ["timeJ", "timeJV2", "timeSCP"],
    TIME_Q: ["timeQ", "timeK"],
    TIME_N: ["timeN"],
    TIME_S: ["timeS"],
    OXYGEN: [
    ...
    LATITUDE: ["latitude", "LATITUDE", "lat", "LAT", "Latitude", "Lat"],
    LONGITUDE: ["longitude", "LONGITUDE", "lon", "LON", "Longitude", "Lon"],
    POWER_SUPPLY_INPUT_VOLTAGE: ["Vbatt", "Vcharge", "Vmote"],
    EAST_VELOCITY: [
        "east_velocity",
        "eastward_velocity",
    ...
    EAST_AMPLITUDE: ["Amplitude (Beam1)", "Eastward amplitude"],
    NORTH_AMPLITUDE: ["Amplitude (Beam2)", "Northward amplitude"],
    UP_AMPLITUDE: ["Amplitude (Beam3)", "Upward amplitude"],
    SPEED_OF_SOUND: ["Soundspeed", "Speed of Sound", "speed_of_sound"],
    CHLOROPHYLL: ["Chlorophyll"],
    FLUORESCENCE: ["flECO-AFL", "Fluorescence"],
    ALTIMETER: ["altM", "altimeter"],
    DENSITY: [
        "sigma-t00",
        "sigma-t11",
        "sigma-theta00",
